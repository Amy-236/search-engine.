package com.example.searchengine.mapper;
...
public interface RepositoryMapper extends BaseMapper<RepositoryEntity> {
    ...
    int insert(RepositoryEntity repository);
    ...
    @Insert("<script>" +
            ...
            "</foreach>" +
            "</script>")
    int batchInsert(@Param("list") List<RepositoryEntity> repositories);
    ...
    RepositoryEntity selectById(Long id);
    ...
    RepositoryEntity selectByRepositoryId(Long repositoryId);
    ...
    List<RepositoryEntity> selectByFullName(String fullName);
    ...
    int update(RepositoryEntity repository);
    ...
    @Select("<script>" +
            ...
            ")" +
            "</script>")
    List<RepositoryEntity> selectByIdsInOrder(@Param("ids") List<Long> ids);
} 